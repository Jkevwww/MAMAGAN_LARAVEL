        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="text-lg font-bold tracking-wide text-cyan-800">
                        MAMAGAN
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 sm:gap-3">
                <a href="{{ route('login') }}" class="text-sm font-semibold text-slate-700 hover:text-cyan-700">Log in</a>
                <a href="{{ route('register') }}" class="rounded-md bg-cyan-700 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-600">Register</a>
            </div>
            @endauth
